    ...
    <div class="row">
        <form method="post" enctype="multipart/form-data">
            <div class="col-sm-6 b-r">
                <h3 class="m-t-none m-b">Tambah Kategori Produk Lain</h3>

                <div class="form-group"><label>Nama Produk</label> <input name="nama_produk" type="text" placeholder="Nama Produk" class="form-control"></div>
                <div>
